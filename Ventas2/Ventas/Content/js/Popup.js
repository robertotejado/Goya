$(function () { 
    ...
    var arraydeProductos = new Array(); // va al controlador  , el id  y la cantidad o peso del producto. 
  ...
  $(".botonEliminarProducto button").on("click", function () {
      ...
      var tdrestar = $(this).parent().parent();
      var trrestar = $(tdrestar).find("td:nth-child(2)").html();
      alert(trrestar);
      var preciorestar = (parseFloat(trrestar.replace(/,/g, '.')).toFixed(2));//Reemplazo de comas por puntos y redondeo de 2 digitos
